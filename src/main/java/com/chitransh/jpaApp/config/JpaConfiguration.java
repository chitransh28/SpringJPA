package com.chitransh.jpaApp.config;
...
@EnableJpaRepositories(basePackages={"com.chitransh.jpaApp.repositories"})
...
public class JpaConfiguration {
	...
	public EntityManagerFactory entityManagerFactory(){
		...
		lef.setPackagesToScan("com.chitransh.jpaApp.model");
